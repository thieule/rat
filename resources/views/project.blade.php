...
<div class="">
	<div class="page-title">
		<div class="title_left">
			<h3>Aussie toolbox <small> current</small></h3>
		</div>

		<div class="title_right">
			<a class="btn btn-app" style="float: right" href="{{ url ('all_project') }}">
				<span class="badge bg-green">3</span>
				<i class="fa fa-th-large"></i> All Project
			</a>
					...
					<div class="col-md-3 col-sm-3 col-xs-12">
						...
						<section class="panel">
							...
							<div class="panel-body">
								<h3 class="green"><i class="fa fa-paint-brush"></i> Aussie toolbox</h3>
